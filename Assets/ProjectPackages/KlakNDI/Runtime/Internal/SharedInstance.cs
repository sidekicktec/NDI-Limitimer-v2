...
static class SharedInstance
{
    ...
    static public Interop.Send FullViewSend
      => _gameViewSend ?? InitializeFullViewSend();

    static public bool IsFullViewSend(Interop.Send send)
    ...
    static Interop.Send InitializeFullViewSend()
    {
        _gameViewSend = Interop.Send.Create("Limitimer (Full)");
        SetFinalizer();
